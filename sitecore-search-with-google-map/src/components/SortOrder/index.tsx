...
const SortOrder = ({ options, selected }: SortOrderProps) => {
  ...
  return (
    ...
    >
      <SortSelect.Trigger className="cursor-pointer [&_span]:w-max [&_span]:text-[16px] text-black inline-flex items-center bg-transparent gap-1 py-1 px-4 py-[20px] border-0 focus:outline-none">
